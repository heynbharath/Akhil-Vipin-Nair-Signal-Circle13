                    ...
                    >
                      ...
                      <div className="flex justify-between items-start z-10 relative">
                        ...
                        <div className="w-16 h-16 rounded-full flex items-center justify-center relative shrink-0 select-none liquid-glass !rounded-full shadow-lg">
                          ...
                          <div className="relative z-10 w-full h-full p-3 drop-shadow-[0_2px_4px_rgba(0,0,0,0.4)]">
                            <Image src="/brand/C13-logo.png" alt="C13 Logo" fill className="object-contain" />
                          </div>
                        </div>
                      </div>
